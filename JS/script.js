function myFunction() {
    var menu = document.getElementById("myNavbar"); //Hittar ID i dokumentet som heter "myNavbar"
    if (menu.className === "navbar") { //Om klassnamnet är navbar så ändrar den klassnamnet till responsive och då körs den koden i css
      menu.className += " responsive";
    } else {
      menu.className === "navbar"; //Om responsive är aktivt så körs den här istället och resettar menyn till original
    }
  }
